...
class ResumeParser:
    ...
    def generate_resume_json(self, pdf_path, output_path):
        extracted_text = self.extract_text_from_pdf(pdf_path)
        resume_sections = self.split_resume_sections(extracted_text)
        resume_storage = {}
    ...
    """
    def parse_resume_with_gemini(self, pdf_path: str, 
    ...
    def usage_extract_with_gemini(self, pdf_path, output_json_path):
...
if __name__ == "__main__":
    parser = ResumeParser()
    # parser.generate_resume_json("resume.pdf", "resume.json")
    pdf_path = "/Users/trongphan/Desktop/LinkediNTU/apps/ai-api/utils/data/resume_pdf/LeDucManh_Resume.pdf"
    folder_path = "/Users/trongphan/Desktop/LinkediNTU/apps/ai-api/utils/data/processed_resume"
    output_path = folder_path+"manh_parsed_resume_gemini.json"
    
    # Test new parser class
    parser.usage_extract_with_gemini(pdf_path, output_path)
